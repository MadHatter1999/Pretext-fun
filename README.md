...
Vite + React + TypeScript app that turns a public-domain excerpt of *Alice's Adventures in Wonderland* into a responsive reading experience powered by `@chenglou/pretext`, plus a realtime color ASCII lab for video-driven typography.
...
- Uses Project Gutenberg text and public-domain John Tenniel illustrations.
